def main():
    ...
    basepath="D:/Kirti Project/23ci1610/23ci1610/code/100% pest identification/dataset"
    ...
    classifier.add(Dense(30, activation = 'softmax'))  #change class no.
    ...
    #Saving the model
    #import h5py
    classifier.save(basepath + '/pest_model1.h5')
